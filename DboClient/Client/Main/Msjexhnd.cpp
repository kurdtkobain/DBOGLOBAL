...
//
TCHAR MSJExceptionHandler::m_szLogFileName[NTL_MAX_DIR_PATH];
...
MSJExceptionHandler::MSJExceptionHandler( )
{
    ...
    GetModuleFileName( 0, m_szLogFileName, NTL_MAX_DIR_PATH );
...
void MSJExceptionHandler::SetLogFileName( PTSTR pszLogFileName )
{
    ...
    _tcscpy_s( m_szLogFileName, NTL_MAX_DIR_PATH, pszLogFileName );
#else
    ...
    PEXCEPTION_POINTERS pExceptionInfo )
{
    ...
    TCHAR szFaultingModule[NTL_MAX_DIR_PATH];
...
void MSJExceptionHandler::IntelStackWalk( PCONTEXT pContext )
{
    ...
    do
    {
        TCHAR szModule[NTL_MAX_DIR_PATH] = _T("");
