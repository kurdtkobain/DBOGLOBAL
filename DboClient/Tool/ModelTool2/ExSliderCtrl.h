...
#define EXSM_MARKER_COPY    (WM_USER + 106)
#define EXSM_MARKER_PASTE   (WM_USER + 107)
...
private:
    ...
    EAnimEventType m_eEventMode; ///< 슬라이드에 설정된 Anim EventMode
...
public:
	...
	*/
    ...
    void SetEventMode(EAnimEventType eMode);    ///< 어떤 마커를 표시할지 모드를 선택한다.
    EAnimEventType GetEventMode() {return m_eEventMode;}; ///< 현재 어떤 이벤트 모드인지를 반환한다.
