...
float CTBTimer::m_fAppTime		= 0.0f;
float CTBTimer::m_fElapsedTime	= 0.0f;
float CTBTimer::m_fFps			= 0.0f;
...
void __stdcall CTBTimer::StartTimer(void)
{
	CTBTimer::DXUtil_Timer( CTBTimer::TIMER_START );
}

void __stdcall CTBTimer::UpdateTimer(void)
{
	m_fAppTime		= CTBTimer::DXUtil_Timer( CTBTimer::TIMER_GETAPPTIME );
	m_fElapsedTime	= CTBTimer::DXUtil_Timer( CTBTimer::TIMER_GETELAPSEDTIME );

	CTBTimer::UpdateFrame(m_fFps);
}


float __stdcall CTBTimer::GetAppTime(void)
{
	return m_fAppTime;
}

float __stdcall CTBTimer::GetElapsedTime(void)
{
	return m_fElapsedTime;
}

float __stdcall CTBTimer::GetFps(void)
{
	return m_fFps;
}

void __stdcall CTBTimer::ActiveInterpolation(bool bActive)
{
